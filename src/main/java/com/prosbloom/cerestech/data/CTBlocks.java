...
public class CTBlocks {
    ...
    public static final BlockEntry<Block> CASING_SUPER_CAPACITOR = createCasingBlock("super_capacitor_casing", GTCEu.id("block/casings/solid/machine_casing_super_capacitor"));
}