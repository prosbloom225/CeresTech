...
public class CTRecipes {
    ...
    private static void registerAssemblerRecipes(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("hi_computation_station_mk1")
                .inputItems(ELITE_CIRCUIT_BOARD, 1)
                .inputItems(ENGRAVED_CRYSTAL_CHIP, 16)
                .inputItems(SYSTEM_ON_CHIP, 32)
                .inputItems(bolt, Copper, 32)
                .inputItems(wireGtSingle, Aluminium, 8)
                .inputItems(rotor, TinAlloy, 4)
                .inputFluids(SolderingAlloy.getFluid(288))
                .outputItems(HI_COMPUTATION_STATION_MK1)
                .duration(1200).EUt(VA[IV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("hi_computation_station_mk2")
                .inputItems(HI_COMPUTATION_STATION_MK1, 2)
                .inputItems(ENGRAVED_CRYSTAL_CHIP, 8)
                .inputItems(NAND_MEMORY_CHIP, 16)
                .inputItems(rotor, Aluminium, 2)
                .inputFluids(Polyethylene.getFluid(288))
                .outputItems(HI_COMPUTATION_STATION_MK2)
                .duration(200).EUt(VA[LuV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("hi_computation_station_mk3")
                .inputItems(HI_COMPUTATION_STATION_MK2, 2)
                .inputItems(ENGRAVED_CRYSTAL_CHIP, 8)
                .inputItems(NAND_MEMORY_CHIP, 16)
                ...
                .duration(200).EUt(VA[ZPM])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("hi_computation_station_mk4")
                .inputItems(HI_COMPUTATION_STATION_MK3, 2)
                .inputItems(ENGRAVED_CRYSTAL_CHIP, 8)
                .inputItems(NAND_MEMORY_CHIP, 16)
                .inputItems(rotor, StainlessSteel, 2)
                .inputFluids(Polyethylene.getFluid(288))
                ...
                .duration(200).EUt(VA[UV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("hi_computation_station_mk5")
                .inputItems(HI_COMPUTATION_STATION_MK4, 2)
                .inputItems(ENGRAVED_CRYSTAL_CHIP, 8)
                .inputItems(NAND_MEMORY_CHIP, 16)
                .inputItems(rotor, StainlessSteel, 2)
                .inputFluids(Polyethylene.getFluid(288))
        ...
        ASSEMBLER_RECIPES.recipeBuilder("compact_fusion_mk1")
                ...
                .inputItems(HI_COMPUTATION_STATION_MK1, 8)
    ...
    private static void registerAssemblyLineRecipes(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder("void_quarry_zpm")
                ...
                .inputItems(EMITTER_ZPM, 9)
                .inputItems(FIELD_GENERATOR_ZPM, 9)
                .inputItems(screw, NaquadahAlloy, 36)
                .inputFluids(Neon.getFluid(20000))
                .inputFluids(SolderingAlloy.getFluid(1440))
                .outputItems(VOID_QUARRY[ZPM])
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder("compact_fusion_mk2")
                ...
                .inputItems(HI_COMPUTATION_STATION_MK2, 8)
                ...
                .duration(6000).EUt(VA[ZPM])
                .save(provider);
        ASSEMBLY_LINE_RECIPES.recipeBuilder("compact_fusion_mk3")
                .inputItems(FUSION_REACTOR[UV], 48)
                ...
                .inputItems(gearSmall, HSLASteel, 32)
                .inputFluids(TanmolyiumBetaC.getFluid(2304))
                .inputFluids(Dalisenite.getFluid(1152))
