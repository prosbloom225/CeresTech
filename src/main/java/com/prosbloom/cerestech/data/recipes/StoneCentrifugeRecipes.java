...
public class StoneCentrifugeRecipes {
    ...
    public static List<StoneCentrifuge> stones = List.of(
            ...
            //new StoneCentrifuge(STONE_MERCURY.get(), new Material[]{Vanadium, Tungstate, Draconium, Titanium, Jade, Diamond}, Helium3.getFluid(1800), 6480, EV),
            ...
            // T5
            //new StoneCentrifuge(STONE_ENCELADUS.get(), new Material[]{Chromium, IridiumMetalResidue, RarestMetalMixture, MysteriousCrystal, Trinium, Naquadah}, Nitrogen.getFluid(5400), 111780, EV),
            new StoneCentrifuge(STONE_MIRANDA.get(), new Material[]{Tin, Tetrahedrite, IridiumMetalResidue, Carbon, Chromium, RarestMetalMixture}, Argon.getFluid(1800), 6480, EV),
            new StoneCentrifuge(STONE_TITAN.get(), new Material[]{Nickel, IridiumMetalResidue, RarestMetalMixture, Emerald, Gallium, Trinium}, Methane.getFluid(3600), 6480, EV),
            new StoneCentrifuge(STONE_OBERON.get(), new Material[]{IridiumMetalResidue, RarestMetalMixture, Naquadah, Uranium235, Plutonium241, Trinium}, Argon.getFluid(1800), 6480, EV),
            // T6
            new StoneCentrifuge(STONE_TRITON.get(), new Material[]{Gold, Neodymium, RareEarth, Niobium, Yttrium, Gallium}, null, 6048, IV),
            new StoneCentrifuge(STONE_PROTEUS.get(), new Material[]{Copper, Uraninite, Adamantium, Diamond, Uranium238, Plutonium239}, Radon.getFluid(360), 6480, IV),
            // T7
            new StoneCentrifuge(STONE_HAUMEA.get(), new Material[]{Gold, Naquadah, NetherStar, Lanthanum, Caesium, Cerium}, null, 12960, IV),
            new StoneCentrifuge(STONE_MAKEMAKE.get(), new Material[]{GarnetRed, GarnetYellow, BlackPlutonium, Gallium, Yttrium, Niobium}, null, 6480, IV),
            new StoneCentrifuge(STONE_PLUTO.get(), new Material[]{Thorium, Uranium238, BlackPlutonium, GarnetYellow, GarnetRed, Naquadah}, null, 6480, IV),
            // T8
            new StoneCentrifuge(STONE_CENTAURI_B.get(), new Material[]{RarestMetalMixture, NaquadahEnriched, Neutronium, BlackPlutonium, CosmicNeutronium, InfinityCatalyst}, Mercury.getFluid(7200), 6480, LuV)
            //new StoneCentrifuge(STONE_BARNARDA_F.get(), new Material[]{Gallium, Yttrium, Niobium, Neutronium, Bedrockium, Unstable}, null, 7776, LuV),
            //new StoneCentrifuge(STONE_VEGA_B.get(), new Material[]{Uranium235, Plutonium241, Europium, Neutronium, Naquadah, AwakenedDraconium}, null, 6480, LuV),
            //new StoneCentrifuge(STONE_TCETI_E.get(), new Material[]{Lapis, Apatite, Bedrockium, Draconium, InfinityCatalyst, Trinium}, null, 6480, LuV),
            //new StoneCentrifuge(STONE_BARNARDA_E.get(), new Material[]{Niobium, Yttrium, Gallium, Neutronium, Bedrockium, Unstable}, null, 6480, LuV)
    );
